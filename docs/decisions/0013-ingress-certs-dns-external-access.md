...
- **Status:** Accepted — ingress + certs implemented (NGF + shared Gateway + DNS-01 wildcard, 2026-09-05, see worklog); split-horizon DNS and external access (Tunnel/Tailscale) not yet; the internal-resolver approach is still **Open**
